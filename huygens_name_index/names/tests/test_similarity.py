...
#            (Name('Johanness Henricus Scholten'), Name('Scholten, J.')),
        ...
        self.assert_more_similar([
            (Name('Johannes Stéénmeijer'), Name('Steenmeyer, Johannes')),
            benchmark
          ])            
        self.assert_more_similar([
            (Name('Maria, gravin van Nassau (1)'), Name('Maria, gravin van Nassau (2)')),
            benchmark
          ])             
        ...
        self.assert_more_similar([
             benchmark_top,
            (Name('Feith, Rhijnvis'), Name('Feith, Johan Adriaan' )), 
        ])   
