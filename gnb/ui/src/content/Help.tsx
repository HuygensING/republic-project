...
function HelpHtml() {
  return <>
    ...
    <p>GNB bestaat uit drie stappen: ten eerste kunt u zoeken op aanwezigen, genoemden, locaties en zoektermen. In het resoluties-histogram worden de gevonden resoluties getoond. Als u niet zoekt, worden alle resoluties getoond.</p>
